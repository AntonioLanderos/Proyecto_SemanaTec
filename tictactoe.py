...
1. Verifica filas, columnas y diagonales completas
2. Identifica ganador
3. Detecta el empate
4. Mensaje de fin de juego, si ganan X o O o si hay un empate
5. Variable game_over para deshabilitar clicks después del fin del juegp
6.Función show_message() para mostrar el resultado
